...
function main() {
    ...
    document.getElementById("btn-close-edhec").addEventListener("click", function() {
        document.getElementById("banner-edhec").style.display = "none";
    });
    
    // var edhec = document.getElementById("banner-edhec").style.display
    // if (edhec == "flex") {
    //     document.getElementsByClassName("container-2").style.opacity = 0;
    // }
    ...
    document.getElementById("btn-close-exam").addEventListener("click", function() {
    ...
    document.getElementById("btn-close-recamier").addEventListener("click", function() {
    ...
    document.getElementById("btn-close-lyon2").addEventListener("click", function() {
    ...
    document.getElementById("btn-close-blaise").addEventListener("click", function() {
        document.getElementById("banner-blaise").style.display = "none";
    });
    ...
    document.getElementById("btn-close-homerun").addEventListener("click", function() {
